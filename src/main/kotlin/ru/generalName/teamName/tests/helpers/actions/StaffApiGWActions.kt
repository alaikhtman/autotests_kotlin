...
import ru.samokat.mysamokat.tests.helpers.controllers.staffApiController.StaffAuthController
import ru.samokat.mysamokat.tests.helpers.controllers.staffApiController.StaffStaffPartnerController
import ru.samokat.mysamokat.tests.helpers.controllers.staffApiController.StaffUsersApiController


@Component
@Scope("prototype")
class StaffApiGWActions {
    ...
    fun deleteComment(accessToken: String, userId: String) {
        staffApiGWPreconditions.fillCommentRequest(comment = null)
        addComment(accessToken, staffApiGWPreconditions.commentRequest(), userId)
    }
