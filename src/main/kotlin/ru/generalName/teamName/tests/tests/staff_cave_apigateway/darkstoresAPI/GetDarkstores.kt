package ru.samokat.mysamokat.tests.tests.staff_cave_apigateway.darkstoresAPI
...
class GetDarkstores {
    ...
    @Test
    @Tags(Tag("contract"))
    @DisplayName("Check darkstores list contract by tech-support")
    fun checkDarkstoresListContractTechSupportTest(){
        ...
        scActions.getDarkStoresList(tokens.accessToken)!!
    }

    @Test
    @DisplayName("Check darkstores list contract by staff-manager")
    fun checkDarkstoresListContractStaffManagerTest(){
        val profile = commonPreconditions.createProfile(
